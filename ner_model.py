...
class NERModel(Model):
    ...
    def fit(self, sess, saver, train_examples_raw, dev_set_raw):
        ...
        #print("**********Writing raw data before sequence processing to a file:*****************")
        #with open("F:/Jupyter/NLP/assignment3/train_examples_raw.txt","w") as f:
            #f.write(str(train_examples_raw))
        with open("F:/Jupyter/NLP/assignment3/train_examples_raw_win1.pkl","wb") as f:
            pickle.dump(train_examples_raw,f)
        with open("F:/Jupyter/NLP/assignment3/dev_set_raw_win1.pkl","wb") as f:
            pickle.dump(dev_set_raw,f)
